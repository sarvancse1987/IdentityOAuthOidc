    ...
    public class Startup
    {
        ...
        private readonly List<Client> clients = new List<Client>
        {
            new Client
            {
                ...
                RedirectUris = new List<string> {"http://localhost:4400/auth-callback", "http://localhost:4400/silent-refresh.html"},
                PostLogoutRedirectUris = new List<string> {"http://localhost:4400/"},
                AllowedCorsOrigins = new List<string> {"http://localhost:4400"},
